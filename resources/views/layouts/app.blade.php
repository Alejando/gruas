                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li class="dropdown-header">Catalogo de costos de servicio</li>
                            <li><a href="{{ url('/particulars')}}">Particular</a></li>
                            <li><a href="{{ url('/assistances')}}">Asistencia</a></li>
                            <li><a href="{{ url('/movilities')}}">Movilidad</a></li>
                            <li><a href="{{ url('/police')}}">Policia</a></li>
                            <li><a href="{{ url('/businesses')}}">Empresa</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li class="dropdown-header">Catalogo de vehiculos</li>
                            ...
                            <li><a href="{{ url('/types')}}">Tipos</a></li>
                            @role('admin')
