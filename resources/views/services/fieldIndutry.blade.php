...
<div class="form-group col-sm-6 col-lg-4">
    ...
    <input type="text" name="colony" id="txt3" class="form-control" placeholder="Introduce colonia" />
</div>
...
<div class="form-group col-sm-6 col-lg-4">
   ...
   <input type="text" name="street_deliver" id="txt5" class="form-control" placeholder="Introduce localización" />
</div>

<!--- Number Deliver Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('number_deliver', 'Número de entrega:') !!}
    {!! Form::text('number_deliver', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6 col-lg-4">
    ...
    <input type="text" name="colony_deliver" id="txt6" class="form-control" placeholder="Introduce colonia" />
</div>

<!--- Municipality Deliver Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('municipality_deliver', 'Municipio de entrega:') !!}
    <input type="text" name="municipality_deliver" id="txt7" class="form-control" placeholder="Introduce Municipio" />
</div>
...
<div class="form-group col-sm-6 col-lg-4">
    ...
    {!! Form::select('description', $description, null, ['id'=>'Description', 'class' => 'form-control']) !!}
</div>

<!--- Zone Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('zone', 'Zone:*') !!}
    {!! Form::select('zone',['Dentro de periférico' => 'Dentro de periférico'], null, ['class' => 'form-control']) !!}
</div>
<!--- abanderamiento Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('flag', 'Abanderamiento') !!}
...
<div class="form-group col-sm-6 col-lg-4">
    ...
    {!! Form::text('time_request', null, ['class' => 'form-control']) !!}
</div>

<!--- Time Promise Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('time_promise', 'Hora estimada de Arribo:*') !!}
    {!! Form::text('time_promise', null, ['class' => 'form-control']) !!}
</div>
{{-- 
<!--- Real Time Field --->
<div class="form-group col-sm-6 col-lg-4">
